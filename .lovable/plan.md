...
O switcher flutuante no canto superior direito (igual ao "Wireframes Demo" do Figma) lista as 5 telas + badge "Autenticado", como atalho de navegação entre as telas.
...
## Fora de escopo
- Autenticação real, banco, upload real de arquivos, edição persistente. (Pode ser ativado depois com Lovable Cloud.)
