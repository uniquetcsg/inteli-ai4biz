...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AI FOR BUSINESS" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-foreground md:text-5xl">AI FOR BUSINESS</h1>
            ...
            return (
              <div key={m.title} className="border-2 border-primary bg-card">
                ...
                >
                  ...
                  <div className="flex w-28 flex-col items-center justify-center gap-2 bg-segment px-4 text-segment-foreground">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="flex h-10 w-10 items-center justify-center bg-segment">
                              <Icon className="h-5 w-5 text-segment-foreground" />
                            </div>
